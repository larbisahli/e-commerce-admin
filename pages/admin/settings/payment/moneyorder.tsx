...
const MoneyOrderForm = dynamic(
  () => import('@components/payments/money-order-form'),
  { ssr: true }
);
...
export default function MoneyOrder({ client }: SSRProps) {
  ...
  return (
    <>
      <Head>
        <title>Money Order | Dropgala</title>
        <link
          rel="icon"
          type="image/svg"
          sizes="32x32"
      ...
      <MoneyOrderForm initialValues={getPayment}/>
    </>
  );
}
MoneyOrder.Layout = AppLayout;
