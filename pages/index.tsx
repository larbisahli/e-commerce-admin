    ...
    <div className="h-screen pb-14">
      ...
      <main className="pt-16 lg:pt-20">
        ...
        <ScrollAnimation animateOnce animateIn="slideInUp">
          <section className="container my-14 mx-auto flex flex-col-reverse flex-wrap items-center justify-between px-0 md:flex-row lg:px-4">
            {/* <!--Right Col--> */}
            ...
            <div className="flex w-full flex-col items-center justify-center overflow-y-hidden lg:items-start xl:w-2/5">
              ...
              <p className="slide-in-bottom-subtitle pb-8 text-center text-base leading-normal text-gray-700 md:text-left">
                DropGala gives you all the tools, features, and services you
                need to achieve your ecommerce success.
              </p>
              {/* <Link href={'#features'}>
        ...
        <ScrollAnimation animateOnce animateIn="slideInUp">
          <section
            id="subscription"
            className="container my-22 mx-auto flex flex-col-reverse flex-wrap items-center justify-between px-2 md:flex-row"
          >
            {/* <!--Left Col--> */}
            <div className="flex w-full flex-col items-center justify-center overflow-y-hidden">
              ...
              <p className="text-center">
                Sign up for our Waitlist and move one step closer to achieving
                your dream!
              </p>
