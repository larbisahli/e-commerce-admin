        ...
        {RecommendedPosts?.map((post) => {
          return (
            <Link target="_block" key={post.id} href={post.link}>
              <div className="group flex border-b border-gray-300 p-5 sm:h-[150px] sm:p-0">
                <div className="flex flex-col items-center justify-center sm:flex-row">
                  ...
                  <div className="mx-3 my-3 flex max-w-screen-sm flex-col items-center sm:my-0 sm:items-start">
                    <h2
                      title={post.title}
                    ...
                    <p className="cut-line-3 max-3-lines prose mb-1 max-w-none text-center text-sm leading-5 text-gray-500 sm:text-start">
                      {post.description}
                    </p>
