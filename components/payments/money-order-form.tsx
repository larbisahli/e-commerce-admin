...
export default function MoneyOrderForm({ initialValues }: IProps) {
  ...
  const [state, setState] = useState({
    name: 'Money Order',
    description: `Type instructions to pay by money order in here.`,
    countries: [
      {
        iso2: 'XX',
        name: '-- All Countries --'
  ...
  const onSubmit = async (e) => {
    ...
    const variables = {
      code: offlinePaymentCodes.moneyOrder,
      data: {
        ...state,
    ...
    <form onSubmit={onSubmit}>
      ...
      <div className="my-5 flex flex-wrap sm:my-8">
        <Description
          ...
          details={"To integrate Money Orders into your store simply complete the form below and click the 'Save' button."}
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          ...
          <div className="mb-5">
            ...
            />
            <p className='text-gray-500 text-xs my-2'>Which countries do you want to offer Money Orders to? If the customers billing country matches any of the selected countries then they will have the option to pay by money order.</p>
          </div>
          <TextArea
            ...
            className="mb-6"
            rows={7}
            note='If a customer chooses to pay with a money order then he will be shown the text you type into this box once he completes his order. You should include your store address so he can mail the money order to you, and also any information relating to the order including how you will contact the customer when his order is ready to ship, etc.'
          />
        </Card>
      </div>
    </form>
