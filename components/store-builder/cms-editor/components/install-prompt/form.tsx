...
const InstallPromptForm = ({ initialValues }: IProps) => {
      ...
      <div className="my-5 flex flex-wrap border-b border-dashed border-border-base pb-8 sm:my-8">
        ...
        <Card className="w-full sm:w-8/12 md:w-2/3">
          <TextArea
            label={'Content'}
            {...register('cookieText')}
            placeholder={'This site uses cookies to provide and...'}
            variant="outline"
            className="mb-5"
          />
          <Input
...
export default memo(InstallPromptForm);
