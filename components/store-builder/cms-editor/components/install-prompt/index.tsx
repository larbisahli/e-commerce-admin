...
import InstallPromptForm from './form';
import InstallPromptStyles from './styles';

type IProps = {
  initialValues?: StoreLayoutComponentType;
};

const InstallPromptContent = ({ initialValues }: IProps) => {
  return (
    <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <InstallPromptForm initialValues={initialValues} />
          </div>
        </Tab.Panel>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <InstallPromptStyles initialValues={initialValues} />
          </div>
        </Tab.Panel>
      </Tab.Panels>
    </Tab.Group>
...
export default memo(InstallPromptContent);
