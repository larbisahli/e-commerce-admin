...
import CategoryListForm from './form';
...
const CategoryListContent = ({ initialValues }: IProps) => {
  return (
    <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <CategoryListForm initialValues={initialValues} />
          </div>
        </Tab.Panel>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <CategoryListStyles initialValues={initialValues} />
          </div>
        </Tab.Panel>
      </Tab.Panels>
    </Tab.Group>
...
export default memo(CategoryListContent);
