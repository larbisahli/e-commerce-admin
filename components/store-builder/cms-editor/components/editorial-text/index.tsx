...
import EditorialTextForm from './form';
import EditorialTextStyles from './styles';

type IProps = {
  initialValues?: StoreLayoutComponentType;
};

const EditorialTextContent = ({ initialValues }: IProps) => {
  return (
    <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <EditorialTextForm initialValues={initialValues} />
          </div>
        </Tab.Panel>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <EditorialTextStyles initialValues={initialValues} />
          </div>
        </Tab.Panel>
      </Tab.Panels>
    </Tab.Group>
...
export default memo(EditorialTextContent);
