...
import ImageBannerForm from './form';
import ImageBannerStyles from './styles';

type IProps = {
  initialValues?: StoreLayoutComponentType;
};

const ImageBannerContent = ({ initialValues }: IProps) => {
  return (
    <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <ImageBannerForm initialValues={initialValues} />
          </div>
        </Tab.Panel>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <ImageBannerStyles initialValues={initialValues} />
          </div>
        </Tab.Panel>
      </Tab.Panels>
    </Tab.Group>
...
export default memo(ImageBannerContent);
