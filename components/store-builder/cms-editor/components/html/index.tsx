...
const PromoSlideContent = ({ initialValues }: IProps) => {
  return (
    <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <HtmlForm initialValues={initialValues} />
          </div>
        </Tab.Panel>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <HtmlStyles initialValues={initialValues} />
          </div>
        </Tab.Panel>
      </Tab.Panels>
    </Tab.Group>
...
export default memo(PromoSlideContent);
