...
import VideoBannerForm from './form';
import { CssStyleIcon } from '@components/icons/builder/css-style';
import VideoBannerStyles from './styles';

type IProps = {
  initialValues?: StoreLayoutComponentType;
};

const VideoBannerContent = ({ initialValues }: IProps) => {
  return (
    <Tab.Group>
      ...
      <Tab.Panels>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <VideoBannerForm initialValues={initialValues} />
          </div>
        </Tab.Panel>
        <Tab.Panel unmount={false}>
          <div className="pt-3">
            <VideoBannerStyles initialValues={initialValues} />
          </div>
        </Tab.Panel>
      </Tab.Panels>
    </Tab.Group>
...
export default memo(VideoBannerContent);
