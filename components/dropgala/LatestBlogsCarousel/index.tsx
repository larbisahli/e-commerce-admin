  ...
  return (
    <div className="">
      <div className="space-y-2 pt-6 pb-5 md:space-y-5">
        <h1 className="md:leading-14 text-center text-4xl font-extrabold leading-9 tracking-tight text-gray-900 sm:leading-10">
          Posts
        </h1>
      ...
      <div className="mt-8 grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4">
