  ...
  return (
    <section className="hero-container mt-0 lg:mt-20">
      <div
        ...
        className="container mx-auto rounded px-2 pb-8 md:flex-row md:pt-12 lg:px-4"
      >
        ...
        <div className="mx-auto mt-8 grid grid-cols-1 gap-5 md:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4">
          {/* 1 */}
          <div className="flex min-h-[150px] min-w-[250px] flex-col items-center justify-center rounded-lg border bg-white shadow">
            <Image
              alt="feature-1"
          ...
          {/* 2 */}
          <div className="shad flex min-h-[150px] min-w-[250px] flex-col items-center justify-center rounded-lg border bg-white">
            <Image
              alt="feature-2"
